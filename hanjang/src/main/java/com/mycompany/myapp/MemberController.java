...
public class MemberController {
	 ...
	 * @ResponseBody
	 * 
	 * @RequestMapping(value="/idcheck.do",produces="text/plane") public String
	 * IDCheck(@RequestBody String paramData) throws ParseException{= String ID =
	 * paramData.trim(); System.out.println(ID); MemberVO mvo =
	 * memberservice1.Id_Check(ID); }
	 */

	@RequestMapping("/kakaologin.do")
	public String home(@RequestParam(value = "code", required = false) String code, HttpSession session)
			throws Exception {
