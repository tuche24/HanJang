...
<table border="1" class="MainBoardLayout">
	...
	<tr>
		...
		<table border="1" class="replyOutputTable">
			...
			<tr>
				<td colspan="4" style="padding:10px; height:30px; background-color:#f5f5f5; border:none; border-radius:4px; text-align:left; vertical-align:middle;">${reply.replyContent }</td>
			</tr>
		</table>
		</td>
	</tr>
	...
	<tr>
		...
		<form id="replyForm" name="replyForm">
			<table border="1" class="replyInputTable">
				<tr>
					<td class="replysection"><textarea id="replyTextarea" class="replytextarea" name="replyContent" placeholder="댓글을 작성해주세요." required="required"></textarea>
	...
	<tr>
		...
		function clickUpdateConfirm() {
			swal.fire({
				...
				if(result.isConfirmed) {
					var boardNo = "<c:out value='${post.boardNo}'/>";
					location.href = "recommendUpdateForm.do?boardNo="+boardNo;
				}
			})
		}
		</script>
