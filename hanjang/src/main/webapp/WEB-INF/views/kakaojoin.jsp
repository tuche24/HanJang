...
<div id="header"></div>
	...
	<div id="wrap">
	 <div class="member_join_field">
		<br><br>
		<div style="text-align:center;"><h2>카카오로 회원가입</h2></div>
		...
		<form method="post" action="JoinPro.do" name="userInfo" 
			...
			<table> 
				...
				<tr>
					...
					<td>
					<c:if test="${(loginNick!=null) ? true : false}">
						<input type="text" name="nickname" maxlength="50" class="input_text_f" value="${loginNick}">
